...
module LearnHelper
  def render_icon(name)
    icons = {
      ...
      "circle" => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />',
    ...
    svg_content = icons[name] || icons["circle"]
    raw(%(<svg class="w-6 h-6 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">#{svg_content}</svg>))
  end
end
